...
class Category(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.image_url:
            self.image_url = (
                "https://d1vp8nomjxwyf1.cloudfront.net/wp-content/uploads/sites/365/2021/03/23101228"
                "/restaurantAmour-%40Pionphotographie-1.jpg"
            )
            self.save()
...
class Address(TimeBasedStampModel):
    ...
    google_place_id = models.UUIDField(max_length=255, blank=True, null=True)
    icon_id = models.UUIDField(max_length=255, blank=True, null=True)
